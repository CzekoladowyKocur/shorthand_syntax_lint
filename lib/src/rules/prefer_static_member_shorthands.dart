...
class PreferStaticMemberShorthands extends AnalysisRule {
  ...
  PreferStaticMemberShorthands()
    : super(
        name: 'prefer_static_member_shorthands',
        description: 'Use dot shorthands for static members.',
      );
...
class _Visitor extends SimpleAstVisitor<void> {
  final PreferStaticMemberShorthands rule;
  ...
  void _check(Expression node) {
    ...
    if (longhand == null || longhand.kind != LonghandKind.staticMember) return;
